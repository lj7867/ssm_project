...
<body>
    <form method="post" action="${ctx}/fx/addCgFx" class="layui-form" lay-filter="f">
                ...
                <tr >
                    ...
                    <td>按
                        ...
                        <div style="margin-left: 180px;margin-top: -30px;width: 50px;">，每隔</div>
                            ...
                            <select name="costPeriod" lay-filter="aihao" disabled="disabled" >
                    ...
                    <tr id="g">
                        ...
                        <td>
                                ...
                                <div style="margin-left: 120px;margin-top: -36px">
                                    ...
                                    <input type="hidden" name="costStair" id="jsfs"/>
                                </div>
                        </td>
                    </tr>
                </tbody>
